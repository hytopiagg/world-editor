    ...
    return (
        <aside className="bg-[#0e1117] border-r-0 p-5 flex flex-col gap-4 w-[280px]">
            <div className="flex items-center justify-start py-[6px]">
                <img src={"./assets/img/Hytopia_Tiny.png"} className="h-6 w-auto" />
            </div>
            ...
            <div className="mt-auto flex flex-col gap-1.5 opacity-85">
                <a href="https://discord.gg/hytopia" target="_blank" rel="noreferrer" className="flex items-center text-[#cb6cf6] no-underline text-[13px]">
                    <svg viewBox="0 0 24 24" width="16" height="16" className="mr-2 inline-block">
                ...
                <a href="https://x.com/hytopiagg" target="_blank" rel="noreferrer" className="flex items-center text-[#1DA1F2] no-underline text-[13px]">
                    <svg viewBox="0 0 300 271" width="16" height="16" className="mr-2 inline-block">
